      ...
      <div className="relative flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <div className="text-center">
            ...
            <div className="text-[10px] text-violet-200">Total</div>
          </div>
          <div className="w-px h-10 bg-white/20" />
          <div className="text-center">
            <div className="text-2xl font-bold text-emerald-300">{activos}</div>
            <div className="text-[10px] text-violet-200">Activos</div>
          </div>
          <div className="w-px h-10 bg-white/20" />
          <div className="text-center">
            <div className="text-2xl font-bold text-violet-300">{ejecuciones.toLocaleString()}</div>
            <div className="text-[10px] text-violet-200">Ejecuciones</div>
          </div>
          <div className="w-px h-10 bg-white/20" />
          <div className="text-center">
            <div className="text-2xl font-bold text-emerald-300">{tasaExito}%</div>
            <div className="text-[10px] text-violet-200">Exito</div>
          </div>
        </div>
      </div>
    </div>
