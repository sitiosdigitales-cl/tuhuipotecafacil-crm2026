...
export function fromSupabaseColumns(obj: Record<string, unknown>): Record<string, unknown> {
  ...
  const keyMap: Record<string, string> = {
    ...
    financiamiento_maximo: "financiamientoMaximo",
    plazo_maximo: "plazoMaximo",
    pie_minimo: "pieMinimo",
    pie_maximo: "pieMaximo",
    complemento_renta: "complementoRenta",
    ...
    tiempo_escrituracion: "tiempoEscrituracion",
    tiempo_pago: "tiempoPago",
    comision_convenio: "comisionConvenio",
    requisitos_minimos: "requisitosMinimos",
    tasas_por_tipo: "tasasPorTipo",
