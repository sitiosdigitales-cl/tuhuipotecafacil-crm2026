...
export const USUARIOS_MOCK: Usuario[] = [
  ...
  { id: "u3", nombre: "Carolina", apellido: "Muñoz", email: "carolina.munoz@tuhipotecafacil.cl", rol: "ADMIN", estado: "ACTIVO", ultimoAcceso: new Date(Date.now() - 86400000), creadoEn: new Date("2024-03-10") },
  ...
  { id: "u8", nombre: "Roberto", apellido: "Silva", email: "roberto.silva@tuhipotecafacil.cl", rol: "ADMIN", estado: "ACTIVO", ultimoAcceso: new Date(Date.now() - 43200000), creadoEn: new Date("2024-08-10"), dosFA: true },
];
