...
// Datos mock de landing pages
const LANDING_PAGES_MOCK = [
  {
    id: "lp1",
    nombre: "Crédito Hipotecario Express",
    url: "https://tuhipotecafacil.cl/landing/credito-express",
    estado: "ACTIVA",
    tipo: "CONVERSION",
    descripcion: "Landing page para captación de leads interesados en crédito hipotecario rápido",
    visits: 12450,
    leads: 623,
    conversion: 5.0,
    montoPromedio: 150000000,
    formulario: true,
    whatsapp: true,
    chatbot: false,
    fechaCreacion: new Date(2026, 5, 4),
  ...
  {
    id: "lp2",
    nombre: "Refinanciamiento Smart",
    url: "https://tuhipotecafacil.cl/landing/refinanciamiento",
    estado: "ACTIVA",
    tipo: "REFINANCIAMIENTO",
    descripcion: "Landing para clientes que buscan refinanciar su crédito hipotecario",
    visits: 8920,
    leads: 356,
    conversion: 4.0,
    montoPromedio: 180000000,
    formulario: true,
    whatsapp: true,
    chatbot: true,
    fechaCreacion: new Date(2026, 5, 9),
  ...
  },
  {
    ...
    url: "https://tuhipotecafacil.cl/landing/black-friday-2024",
    estado: "FINALIZADA",
    tipo: "PROMOCION",
    descripcion: "Campaña especial Black Friday con tasas preferenciales",
    visits: 25680,
    leads: 1540,
    conversion: 6.0,
    montoPromedio: 120000000,
    formulario: true,
    whatsapp: true,
    chatbot: true,
    fechaCreacion: new Date(2026, 4, 20),
    ultimoInicio: new Date(2026, 5, 19),
    color: "#EF4444",
    template: "Promo",
  },
  {
    ...
    url: "https://tuhipotecafacil.cl/landing/referidos",
    estado: "ACTIVA",
    tipo: "REFERIDOS",
    descripcion: "Invita a amigos y gana recompensas por cada referido convertido",
    visits: 5430,
    leads: 217,
    conversion: 4.0,
    montoPromedio: 0,
    ...
    whatsapp: false,
    chatbot: false,
    fechaCreacion: new Date(2026, 5, 14),
  ...
  {
    id: "lp5",
    nombre: "Simulador de Crédito",
    url: "https://tuhipotecafacil.cl/landing/simulador",
    estado: "ACTIVA",
    tipo: "HERRAMIENTA",
    descripcion: "Simulador interactivo de crédito hipotecario con cálculo automático",
    visits: 18920,
    leads: 945,
    conversion: 5.0,
    montoPromedio: 160000000,
    formulario: true,
    whatsapp: true,
    chatbot: false,
    fechaCreacion: new Date(2026, 5, 19),
  ...
  {
    id: "lp6",
    nombre: "Navidad Hipotecaria",
    url: "https://tuhipotecafacil.cl/landing/navidad-2024",
    estado: "BORRADOR",
    tipo: "PROMOCION",
    descripcion: "Campaña navideña con beneficios especiales de fin de año",
    visits: 0,
    leads: 0,
    conversion: 0,
    montoPromedio: 0,
...
const STATS_GLOBALES = {
  ...
  totalVisitas: 71400,
  totalLeads: 3681,
  conversionPromedio: 5.1,
  montoPromedio: 142000000,
};
