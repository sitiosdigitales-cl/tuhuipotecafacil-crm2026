...
const TIPOS_DOCUMENTO_BASE: TipoDocumentoCustom[] = [
  ...
  { id: "CONTRATO_TRABAJO", nombre: "Contrato de Trabajo", color: "#8B5CF6", esPersonalizado: false },
  { id: "COMPROBANTE_INGRESOS", nombre: "Comprobante de Ingresos", color: "#10B981", esPersonalizado: false },
  { id: "CERTIFICADO_AFP", nombre: "Certificado AFP", color: "#F59E0B", esPersonalizado: false },
  { id: "DECLARACION_RENTA", nombre: "Declaración de Renta", color: "#EF4444", esPersonalizado: false },
  { id: "VALORIZACION", nombre: "Valorización", color: "#06B6D4", esPersonalizado: false },
  { id: "CERTIFICADO_PIE", nombre: "Certificado de Pie", color: "#EC4899", esPersonalizado: false },
];
