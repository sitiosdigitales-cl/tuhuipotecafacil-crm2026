  ...
  return (
      ...
      <header className="bg-white border-b border-slate-100 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-sm font-bold text-slate-900">TuHipotecaFacil.cl</h1>
              <p className="text-[10px] text-slate-400">Simulador de Crédito Hipotecario</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <a href="tel:+56983300597" className="hidden sm:flex items-center gap-1.5 px-3 py-2 text-[11px] font-medium text-slate-600 hover:bg-slate-50 rounded-lg transition-colors">
              <Phone size={14} /> Llamar
            </a>
            <a href="https://wa.me/56983300597" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-1.5 px-4 py-2 bg-green-500 text-white rounded-xl text-[11px] font-semibold hover:bg-green-600 transition-colors shadow-sm">
    ...
    <PreEvaluacionModal
      ...
      datosSimulador={{
        ...
        plazo,
        tasa: tasaFinal,
        banco: bancos.find((b) => b.id === bancoActivoId)?.nombre,
