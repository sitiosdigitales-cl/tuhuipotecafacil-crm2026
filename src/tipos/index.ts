...
export const ETAPAS_CONFIG: Record<Etapa, { label: string; color: string }> = {
  ...
  DOCS_PENDIENTES: { label: "Doc. Pendiente", color: "#F97316" },
  DOCS_PARCIALES: { label: "Doc. Parcial", color: "#FB923C" },
  DOCS_COMPLETAS: { label: "Doc. Completa", color: "#22C55E" },
  EVALUACION_BANCARIA: { label: "Evaluación", color: "#06B6D4" },
  PREAPROBADO: { label: "Preaprobado", color: "#14B8A6" },
  APROBADO: { label: "Aprobado", color: "#10B981" },
  FIRMA_DIGITAL: { label: "Firma Digital", color: "#6366F1" },
